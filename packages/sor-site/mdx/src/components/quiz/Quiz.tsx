/**
 * Quiz — extracted from ag2/apps/learn-app/src/components/quiz/Quiz.tsx at
              ...
              return (
                <div key={index} className={styles.reviewItem}>
                  ...
                  <div className={styles.reviewQuestion}>
                    <ReactMarkdown components={{ p: ({node, ...props}: any) => <p {...props} />, a: ({node, ...props}: any) => <a {...props} target="_blank" rel="noopener noreferrer" /> }}>
                      {q.question}
                    </ReactMarkdown>
                  </div>
                  <div className={styles.reviewAnswers}>
                    <div className={styles.reviewAnswer}>
                      ...
                      <span className={isCorrect ? styles.correctText : styles.incorrectText}>
                        {userAnswer !== null ? (
                          <ReactMarkdown components={{ p: ({node, ...props}: any) => <span {...props} />, a: ({node, ...props}: any) => <a {...props} target="_blank" rel="noopener noreferrer" /> }}>
