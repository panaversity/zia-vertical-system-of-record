...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Center horizontally with inset-x-0 + mx-auto rather than
        // left-1/2 + translate-x-[-50%]. Under dir="rtl" the page's RTL CSS
        // flips the translateX anchor and shoves the dialog one full width
        // off-screen left; margin-auto centering is symmetric and immune to
        // that. The horizontal slide-from-left animation is dropped for the
        // same reason (it momentarily reintroduces the translateX).
